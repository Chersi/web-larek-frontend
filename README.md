...
* selectedCard: IProduct | null — выбранная карточка товара
...
* selectCard(card: IProduct) - Сохраняет выбранную карточку и инициирует перерисовку

* getSelectedCard() - Возвращает текущую выбранную карточку
...
* createFinalOrder() - Формирует финальный объект заказа
...
* triggerRedraw() - Инициирует перерисовку интерфейса
...
## Методы:
* updateButtonText() - Обновляет текст кнопки в зависимости от статуса добавления в корзину
